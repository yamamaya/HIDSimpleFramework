...
/**************************************************************************
    ...
    Remarks:
        ...
        HardwareProfile  E[platform name].h file. 
        ...
        option in the HardwareProfile  E[platform name].h file.  When this 
        ...
        #define USB_BUS_SENSE option in the HardwareProfile  E[platform name].h 
